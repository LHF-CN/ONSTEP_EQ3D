...
#define AXIS1_STEPS_PER_DEGREE    3466.6666667 //  12800, n. Number of steps per degree:                                          <-Req'd
                                          //         n = (stepper_steps * micro_steps * overall_gear_reduction)/360.0
#define AXIS1_STEPS_PER_WORMROT     9600 //  12800, n. Number of steps per worm rotation (PEC Eq mode only:)                <-Req'd
...
#define AXIS2_STEPS_PER_DEGREE    1733.3333333 //  12800, n. Number of steps per degree:                                          <-Req'd
                                          //         n = (stepper_steps * micro_steps * overall_gear_reduction)/360.0
...
#define AXIS3_DRIVER_MICROSTEPS       16 //    OFF, n. Microstep mode when tracking.                   For TMC2130, TMC5160. Option
...
#define AXIS4_DRIVER_MICROSTEPS       16 //    OFF, n. Microstep mode when tracking.                   For TMC2130, TMC5160. Option
...
#define AXIS5_DRIVER_MICROSTEPS       16 //    OFF, n. Microstep mode when tracking.                   For TMC2130, TMC5160. Option
...
#define FEATURE1_NAME          "Intevalometer" // "FE..", Name of feature being controlled.                                        Adjust
#define FEATURE1_PURPOSE              INTERVALOMETER //    OFF, SWITCH, ANALOG_OUT, DEW_HEATER, etc.                                     Option
#define FEATURE1_TEMP                 OFF //    OFF, DS1820, n. Where n is the ds18b20 s/n for DEW_HEATER temperature.        Adjust
#define FEATURE1_PIN                  15 //    OFF, AUX, DS2413, n. Where n is ds2413 s/n (gpio0) or n=0 to 255 (pin#.)      Adjust
